...
<a href="#" class="btn btn-primary">日別平均</a>
...
<div class="container">
  <div class="row">
    <div class="header-title">日別平均</div>
      <form class="form-inline my-2 my-lg-0 ml-2">
        <div class="form-group">
          <input type="date" class="info_form" name="search"  value="<?php echo date('Y-m-d');?>" placeholder="キーワードを入力" aria-label="検索...">
        </div>
    ...
    <table>
      ...
      @foreach ($results as $result)
        <tr>
          ...
          <td>￥{{number_format( floor( $result->day_ave_amount) ) . "\n"}}</td>
          <td>{{ $result-> day_ave_cuont}}件</td>
        </tr>
      @endforeach
      </tbody>
    </table>
